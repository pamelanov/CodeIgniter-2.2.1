            ...
            <?php
                ...
                if (!empty($invoices)) {
                    ...
                    foreach($invoices as $i) {
                        $periodeawal = $i->periode_awal;
                        $periodeakhir = $i->periode_akhir;
                            echo "<tr valign='top'>\n";
                            echo "<td align='center'>" . $i->no_invoice . "</td>\n";
                            echo "<td align='center'>" . $i->kelas . "</td>\n";
                            echo "<td align='center'>" . $i->id_guru . ": " . $i->namaGuru . "</td>\n";
                            echo "<td align='center'>" . date("j F Y", strtotime($periodeawal)) . " - " . date("j F Y", strtotime($periodeakhir)) . "</td>\n";
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body">
                        ...
                        <p><b>9</b> = sudah bayar tapi dicicil</p>
                    </div>
                </div>
            </div>
            </div>
