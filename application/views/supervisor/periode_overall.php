...
<div id ="konten-kecil">
    ...
    <form name='searchSales' action='<?php echo base_url(); ?>index.php/download/download_Ofeedbacks' method='post' >
        ...
        <button type="submit" class="btn btn-danger">
            <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Download Feedback</button>
    </form>
