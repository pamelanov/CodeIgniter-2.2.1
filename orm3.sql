...
--
-- Host: localhost
-- Generation Time: Apr 14, 2015 at 07:08 PM
...
INSERT INTO `beginning_numbers` (`No`, `Id_murid`, `Jam`, `Tanggal`, `Id_sales`) VALUES
(4, 33333, 2330, '2015-04-08', 'DY'),
(5, 33333, 945, '2015-04-17', 'DY');
...
INSERT INTO `engagements` (`Id_kelas`, `Id_guru`, `Id_murid`, `Status`) VALUES
(0, 12345, 55555, 'active');
...
INSERT INTO `invoices` (`No_invoice`, `Id_kelas`, `Id_murid`, `Id_guru`, `Periode`, `Harga_per_jam`, `Jumlah_jam`, `Jumlah_sesi`) VALUES
(789, 0, 99999, 12345, '2015-04-09', 5555, 33, 55);
...
INSERT INTO `refunds` (`Id_guru`, `Id_murid`, `No_invoice`, `Id_kelas`, `Jam_hilang`, `Alasan`, `Action`, `Selisih`, `Id_sales`, `Tanggal`) VALUES
(12345, 99999, 789, 0, 44, 'sdfgsdfg', 'asdfasdf', 4545, 'PT', '2015-04-13');
...
(33333, 'Pamela Novranska', 'PT', 'F', '596796797', 'Jakarta', 'novranska@gmail.com', 'depok city', 'Sukabumi, satu november 93'),
(55555, 'Toto', 'DY', 'M', '3456765', 'Bogor', 'd@d.com', 'jafaksdjkasj', 'sjsjs,fajf'),
(99999, 'Lulu', 'PA', 'F', '345676', 'Jkt', 'djdj@sjsj.com', 'Bogor', 'dhdhd,s dd');
